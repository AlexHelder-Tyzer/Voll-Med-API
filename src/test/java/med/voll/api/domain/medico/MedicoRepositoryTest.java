...
class MedicoRepositoryTest {
    ...
    void seleccionarMedicoConEspecialidadEnFechaEscenario1() {
        ...
        var medico=registrarMedico("Jose", "jose@voll.med","123456", Especialidad.CARDIOLOGIA);
    ...
    @Test
    @DisplayName("deberia retornar un medico cando realice la consulta en la base de datos para ese horario")
    ...
    private void registrarConsulta(Medico medico, Paciente paciente, LocalDateTime fecha){
        ...
        em.flush(); // Asegúrate de que los datos se persistan inmediatamente
    }
